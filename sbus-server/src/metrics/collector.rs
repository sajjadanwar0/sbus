...
impl MetricsCollector {
    ...
    pub fn record(&self, mut run: RunMetrics) {
        ...
        self.total_coord_tokens
            .fetch_add(run.coord_tokens, Ordering::Relaxed);
        self.total_work_tokens
            .fetch_add(run.work_tokens, Ordering::Relaxed);
        self.total_commits
            .fetch_add(run.commit_attempts, Ordering::Relaxed);
        self.total_conflicts
            .fetch_add(run.commit_conflicts, Ordering::Relaxed);
